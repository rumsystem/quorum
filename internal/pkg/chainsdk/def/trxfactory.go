...
type TrxFactoryIface interface {
	...
	GetReqBlocksTrx(keyalias string, groupId string, sessionId string, taskId string, fromEpoch int64, blkReq int64) (*quorumpb.Trx, error)
	GetReqBlocksRespTrx(keyalias string, groupId string, sessionId string, taskId string, requester string, blkReq int64, fromEpoch int64, blocks []*quorumpb.Block, result quorumpb.ReqBlkResult) (*quorumpb.Trx, error)
}
