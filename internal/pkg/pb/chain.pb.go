...
var file_chain_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x41, 0x70, 0x70, 0x4b, 0x65, 0x79, 0x2a, 0x21, 0x0a, 0x0b, 0x50, 0x61, 0x63, 0x6b,
	...
	0x4f, 0x55, 0x43, 0x4e, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0c, 0x0a, 0x08, 0x41, 0x50, 0x50, 0x52,
...
var file_chain_proto_goTypes = []interface{}{
	...
	(*Trx)(nil),            // 9: quorum.pb.Trx
	(*Block)(nil),          // 10: quorum.pb.Block
	(*BlockDbChunk)(nil),   // 11: quorum.pb.BlockDbChunk
	(*ReqBlock)(nil),       // 12: quorum.pb.ReqBlock
	(*BlockSynced)(nil),    // 13: quorum.pb.BlockSynced
	(*BlockProduced)(nil),  // 14: quorum.pb.BlockProduced
	(*ReqBlockResp)(nil),   // 15: quorum.pb.ReqBlockResp
	(*PostItem)(nil),       // 16: quorum.pb.PostItem
	(*DenyUserItem)(nil),   // 17: quorum.pb.DenyUserItem
	(*ProducerItem)(nil),   // 18: quorum.pb.ProducerItem
	(*AnnounceItem)(nil),   // 19: quorum.pb.AnnounceItem
	(*SchemaItem)(nil),     // 20: quorum.pb.SchemaItem
	(*GroupItem)(nil),      // 21: quorum.pb.GroupItem
}
var file_chain_proto_depIdxs = []int32{
	...
	9,  // 2: quorum.pb.Block.Trxs:type_name -> quorum.pb.Trx
	10, // 3: quorum.pb.BlockDbChunk.BlockItem:type_name -> quorum.pb.Block
	10, // 4: quorum.pb.BlockSynced.BlockItem:type_name -> quorum.pb.Block
	10, // 5: quorum.pb.BlockProduced.BlockItem:type_name -> quorum.pb.Block
	...
	10, // 12: quorum.pb.GroupItem.GenesisBlock:type_name -> quorum.pb.Block
