...
var file_chain_proto_rawDesc = []byte{
	...
	0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x41, 0x70, 0x70, 0x4b, 0x65, 0x79, 0x22, 0x70,
	...
	0x2a, 0x21, 0x0a, 0x0b, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x07, 0x0a, 0x03, 0x54, 0x52, 0x58, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x42, 0x4c, 0x4f, 0x43,
	0x4b, 0x10, 0x01, 0x2a, 0xdd, 0x01, 0x0a, 0x07, 0x54, 0x72, 0x78, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x08, 0x0a, 0x04, 0x50, 0x4f, 0x53, 0x54, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x41, 0x55, 0x54,
	0x48, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x43, 0x48, 0x45, 0x4d, 0x41, 0x10, 0x02, 0x12,
	...
	0x50, 0x10, 0x0c, 0x2a, 0x41, 0x0a, 0x0c, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x54,
...
var file_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_chain_proto_goTypes = []interface{}{
	...
	(*AskPeerId)(nil),      // 15: quorum.pb.AskPeerId
	(*AskPeerIdResp)(nil),  // 16: quorum.pb.AskPeerIdResp
	(*BlockProduced)(nil),  // 17: quorum.pb.BlockProduced
	(*ReqBlockResp)(nil),   // 18: quorum.pb.ReqBlockResp
	(*PostItem)(nil),       // 19: quorum.pb.PostItem
	(*DenyUserItem)(nil),   // 20: quorum.pb.DenyUserItem
	(*ProducerItem)(nil),   // 21: quorum.pb.ProducerItem
	(*UserItem)(nil),       // 22: quorum.pb.UserItem
	(*AnnounceItem)(nil),   // 23: quorum.pb.AnnounceItem
	(*SchemaItem)(nil),     // 24: quorum.pb.SchemaItem
	(*GroupItem)(nil),      // 25: quorum.pb.GroupItem
	(*GroupItemV0)(nil),    // 26: quorum.pb.GroupItemV0
