...
type Keystore interface {
	...
	RemoveKey(keyname string, keytype KeyType) (err error) //must call nodeoptions.DelSignKeyMap(keyname string) to remove the keymap,after call RemoveKey successfully
...
//VerifySignByKeyName(keyname string, data []byte, sig []byte, opts ...string) (bool, error)//SignByKeyName(keyname string, data []byte, opts ...string) ([]byte, error)
