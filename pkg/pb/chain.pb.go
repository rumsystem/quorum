...
type GroupChainType int32

const (
	GroupChainType_ARCHIVE_CHAIN GroupChainType = 0
	GroupChainType_DYNAMIC_CHAIN GroupChainType = 1
)

// Enum value maps for GroupChainType.
var (
	GroupChainType_name = map[int32]string{
		0: "ARCHIVE_CHAIN",
		1: "DYNAMIC_CHAIN",
	}
	GroupChainType_value = map[string]int32{
		"ARCHIVE_CHAIN": 0,
		"DYNAMIC_CHAIN": 1,
	}
)

func (x GroupChainType) Enum() *GroupChainType {
	p := new(GroupChainType)
	*p = x
	return p
}

func (x GroupChainType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GroupChainType) Descriptor() protoreflect.EnumDescriptor {
	return file_chain_proto_enumTypes[17].Descriptor()
}

func (GroupChainType) Type() protoreflect.EnumType {
	return &file_chain_proto_enumTypes[17]
}

func (x GroupChainType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GroupChainType.Descriptor instead.
func (GroupChainType) EnumDescriptor() ([]byte, []int) {
...
type GroupItemRumLite struct {
	...
	ConsenseType  GroupConsenseType     `protobuf:"varint,9,opt,name=ConsenseType,proto3,enum=quorum.pb.GroupConsenseType" json:"ConsenseType,omitempty"`
	ChainType     GroupChainType        `protobuf:"varint,10,opt,name=ChainType,proto3,enum=quorum.pb.GroupChainType" json:"ChainType,omitempty"`
...
func (x *GroupItemRumLite) GetChainType() GroupChainType {
	if x != nil {
		return x.ChainType
	}
	return GroupChainType_ARCHIVE_CHAIN
}
...
var file_chain_proto_rawDesc = []byte{
	...
	,
	...
	0x73, 0x65, 0x6e, 0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x37, 0x0a, 0x09, 0x43, 0x68, 0x61,
	0x69, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x71,
	0x75, 0x6f, 0x72, 0x75, 0x6d, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x43, 0x68,
	0x61, 0x69, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x09, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x54, 0x79,
	...
	0x10, 0x01, 0x2a, 0x36, 0x0a, 0x0e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x43, 0x68, 0x61, 0x69, 0x6e,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x11, 0x0a, 0x0d, 0x41, 0x52, 0x43, 0x48, 0x49, 0x56, 0x45, 0x5f,
	0x43, 0x48, 0x41, 0x49, 0x4e, 0x10, 0x00, 0x12, 0x11, 0x0a, 0x0d, 0x44, 0x59, 0x4e, 0x41, 0x4d,
	0x49, 0x43, 0x5f, 0x43, 0x48, 0x41, 0x49, 0x4e, 0x10, 0x01, 0x2a, 0x24, 0x0a, 0x10, 0x48, 0x42,
	0x4d, 0x73, 0x67, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x07,
	...
	0x03, 0x41, 0x55, 0x58, 0x10, 0x01, 0x42, 0x24, 0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_chain_proto_goTypes = []interface{}{
	...
	(GroupChainType)(0),                 // 17: quorum.pb.GroupChainType
...
var file_chain_proto_depIdxs = []int32{
	...
	17, // 35: quorum.pb.GroupItemRumLite.ChainType:type_name -> quorum.pb.GroupChainType
