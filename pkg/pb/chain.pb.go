...
const (
	...
	TrxType_CELLA_REQ      TrxType = 5
	TrxType_CELLA_RESP     TrxType = 6
)
...
type GroupServiceType int32

const (
	GroupServiceType_GROUP GroupServiceType = 0
	GroupServiceType_CELLA GroupServiceType = 1
)

// Enum value maps for GroupServiceType.
var (
	GroupServiceType_name = map[int32]string{
		0: "GROUP",
		1: "CELLA",
	}
	GroupServiceType_value = map[string]int32{
		"GROUP": 0,
		"CELLA": 1,
	}
)

func (x GroupServiceType) Enum() *GroupServiceType {
	p := new(GroupServiceType)
	*p = x
	return p
}

func (x GroupServiceType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GroupServiceType) Descriptor() protoreflect.EnumDescriptor {
	return file_chain_proto_enumTypes[14].Descriptor()
}

func (GroupServiceType) Type() protoreflect.EnumType {
	return &file_chain_proto_enumTypes[14]
}

func (x GroupServiceType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GroupServiceType.Descriptor instead.
func (GroupServiceType) EnumDescriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{14}
}

type CellarServiceType int32

const (
	CellarServiceType_BREW    CellarServiceType = 0
	CellarServiceType_STORAGE CellarServiceType = 1
)

// Enum value maps for CellarServiceType.
var (
	CellarServiceType_name = map[int32]string{
		0: "BREW",
		1: "STORAGE",
	}
	CellarServiceType_value = map[string]int32{
		"BREW":    0,
		"STORAGE": 1,
	}
)

func (x CellarServiceType) Enum() *CellarServiceType {
	p := new(CellarServiceType)
	*p = x
	return p
}

func (x CellarServiceType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CellarServiceType) Descriptor() protoreflect.EnumDescriptor {
	return file_chain_proto_enumTypes[15].Descriptor()
}

func (CellarServiceType) Type() protoreflect.EnumType {
	return &file_chain_proto_enumTypes[15]
}

func (x CellarServiceType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CellarServiceType.Descriptor instead.
func (CellarServiceType) EnumDescriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{15}
}

type CellarGroupStatus int32

const (
	CellarGroupStatus_INIT    CellarGroupStatus = 0
	CellarGroupStatus_SYNCING CellarGroupStatus = 1
)

// Enum value maps for CellarGroupStatus.
var (
	CellarGroupStatus_name = map[int32]string{
		0: "INIT",
		1: "SYNCING",
	}
	CellarGroupStatus_value = map[string]int32{
		"INIT":    0,
		"SYNCING": 1,
	}
)

func (x CellarGroupStatus) Enum() *CellarGroupStatus {
	p := new(CellarGroupStatus)
	*p = x
	return p
}

func (x CellarGroupStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CellarGroupStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_chain_proto_enumTypes[16].Descriptor()
}

func (CellarGroupStatus) Type() protoreflect.EnumType {
	return &file_chain_proto_enumTypes[16]
}

func (x CellarGroupStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CellarGroupStatus.Descriptor instead.
func (CellarGroupStatus) EnumDescriptor() ([]byte, []int) {
...
type BrewServiceTermItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BrewServiceTermItem) Reset() {
	*x = BrewServiceTermItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *BrewServiceTermItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BrewServiceTermItem) ProtoMessage() {}

func (x *BrewServiceTermItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BrewServiceTermItem.ProtoReflect.Descriptor instead.
func (*BrewServiceTermItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{22}
}

func (x *BrewServiceTermItem) GetTerm() string {
	if x != nil {
		return x.Term
	}
	return ""
...
func (x *BrewServiceTermItem) GetContract() []byte {
	if x != nil {
		return x.Contract
	}
	return nil
...
type StorageServiceTermItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StorageServiceTermItem) Reset() {
	*x = StorageServiceTermItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *StorageServiceTermItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StorageServiceTermItem) ProtoMessage() {}

func (x *StorageServiceTermItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StorageServiceTermItem.ProtoReflect.Descriptor instead.
func (*StorageServiceTermItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{23}
}

func (x *StorageServiceTermItem) GetTerm() string {
	if x != nil {
		return x.Term
	}
	return ""
...
func (x *StorageServiceTermItem) GetContract() []byte {
	if x != nil {
		return x.Contract
	}
	return nil
...
type CellarServiceTermItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Type CellarServiceType `protobuf:"varint,1,opt,name=Type,proto3,enum=quorum.pb.CellarServiceType" json:"Type,omitempty"`
	Term []byte            `protobuf:"bytes,2,opt,name=Term,proto3" json:"Term,omitempty"`
}

func (x *CellarServiceTermItem) Reset() {
	*x = CellarServiceTermItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *CellarServiceTermItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellarServiceTermItem) ProtoMessage() {}

func (x *CellarServiceTermItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellarServiceTermItem.ProtoReflect.Descriptor instead.
func (*CellarServiceTermItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{24}
}

func (x *CellarServiceTermItem) GetType() CellarServiceType {
	if x != nil {
		return x.Type
	}
	return CellarServiceType_BREW
}

func (x *CellarServiceTermItem) GetTerm() []byte {
	if x != nil {
		return x.Term
	}
	return nil
...
type BrewServiceProofItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *BrewServiceProofItem) Reset() {
	*x = BrewServiceProofItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *BrewServiceProofItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BrewServiceProofItem) ProtoMessage() {}

func (x *BrewServiceProofItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BrewServiceProofItem.ProtoReflect.Descriptor instead.
func (*BrewServiceProofItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{25}
}

func (x *BrewServiceProofItem) GetProof() []byte {
	if x != nil {
		return x.Proof
	}
	return nil
...
type StorageServiceProofItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *StorageServiceProofItem) Reset() {
	*x = StorageServiceProofItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *StorageServiceProofItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StorageServiceProofItem) ProtoMessage() {}

func (x *StorageServiceProofItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StorageServiceProofItem.ProtoReflect.Descriptor instead.
func (*StorageServiceProofItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{26}
}

func (x *StorageServiceProofItem) GetProof() []byte {
	if x != nil {
		return x.Proof
	}
	return nil
...
type CellarReqProofItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CellarReqProofItem) Reset() {
	*x = CellarReqProofItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *CellarReqProofItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellarReqProofItem) ProtoMessage() {}

func (x *CellarReqProofItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellarReqProofItem.ProtoReflect.Descriptor instead.
func (*CellarReqProofItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{27}
}

func (x *CellarReqProofItem) GetType() CellarServiceType {
	if x != nil {
		return x.Type
	}
	return CellarServiceType_BREW
...
func (x *CellarReqProofItem) GetProof() []byte {
	if x != nil {
		return x.Proof
	}
	return nil
...
type CellarGroup struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Type         CellarServiceType `protobuf:"varint,1,opt,name=Type,proto3,enum=quorum.pb.CellarServiceType" json:"Type,omitempty"`
	Group        *GroupItem        `protobuf:"bytes,2,opt,name=Group,proto3" json:"Group,omitempty"`
	Status       CellarGroupStatus `protobuf:"varint,3,opt,name=Status,proto3,enum=quorum.pb.CellarGroupStatus" json:"Status,omitempty"`
	CurrTopBlock int64             `protobuf:"varint,4,opt,name=CurrTopBlock,proto3" json:"CurrTopBlock,omitempty"`
	LastUpdate   int64             `protobuf:"varint,5,opt,name=LastUpdate,proto3" json:"LastUpdate,omitempty"`
}

func (x *CellarGroup) Reset() {
	*x = CellarGroup{}
	if protoimpl.UnsafeEnabled {
...
func (x *CellarGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellarGroup) ProtoMessage() {}

func (x *CellarGroup) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellarGroup.ProtoReflect.Descriptor instead.
func (*CellarGroup) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{28}
}

func (x *CellarGroup) GetType() CellarServiceType {
	if x != nil {
		return x.Type
	}
	return CellarServiceType_BREW
...
func (x *CellarGroup) GetGroup() *GroupItem {
	if x != nil {
		return x.Group
	}
	return nil
...
func (x *CellarGroup) GetStatus() CellarGroupStatus {
	if x != nil {
		return x.Status
	}
	return CellarGroupStatus_INIT
}

func (x *CellarGroup) GetCurrTopBlock() int64 {
	if x != nil {
		return x.CurrTopBlock
	}
	return 0
}

func (x *CellarGroup) GetLastUpdate() int64 {
	if x != nil {
		return x.LastUpdate
	}
	return 0
...
type CellarItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CellarId           string                   `protobuf:"bytes,1,opt,name=CellarId,proto3" json:"CellarId,omitempty"`
	CellarGroup        *GroupItem               `protobuf:"bytes,2,opt,name=CellarGroup,proto3" json:"CellarGroup,omitempty"`
	CellarBrewerPubkey string                   `protobuf:"bytes,3,opt,name=CellarBrewerPubkey,proto3" json:"CellarBrewerPubkey,omitempty"`
	ServiceTerms       []*CellarServiceTermItem `protobuf:"bytes,4,rep,name=ServiceTerms,proto3" json:"ServiceTerms,omitempty"`
	StorageGroups      []*GroupItem             `protobuf:"bytes,5,rep,name=StorageGroups,proto3" json:"StorageGroups,omitempty"`
	BrewGroups         []*GroupItem             `protobuf:"bytes,6,rep,name=BrewGroups,proto3" json:"BrewGroups,omitempty"`
}

func (x *CellarItem) Reset() {
	*x = CellarItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *CellarItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellarItem) ProtoMessage() {}

func (x *CellarItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellarItem.ProtoReflect.Descriptor instead.
func (*CellarItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{29}
}

func (x *CellarItem) GetCellarId() string {
	if x != nil {
		return x.CellarId
	}
	return ""
...
func (x *CellarItem) GetCellarGroup() *GroupItem {
	if x != nil {
		return x.CellarGroup
	}
	return nil
}

func (x *CellarItem) GetCellarBrewerPubkey() string {
	if x != nil {
		return x.CellarBrewerPubkey
	}
	return ""
}

func (x *CellarItem) GetServiceTerms() []*CellarServiceTermItem {
	if x != nil {
...
func (x *CellarItem) GetStorageGroups() []*GroupItem {
	if x != nil {
...
func (x *CellarItem) GetBrewGroups() []*GroupItem {
	if x != nil {
		return x.BrewGroups
	}
	return nil
...
type CellarSeed struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CellarId             string                   `protobuf:"bytes,1,opt,name=CellarId,proto3" json:"CellarId,omitempty"`
	CellarName           string                   `protobuf:"bytes,2,opt,name=CellarName,proto3" json:"CellarName,omitempty"`
	CellarOwnerPubkey    string                   `protobuf:"bytes,3,opt,name=CellarOwnerPubkey,proto3" json:"CellarOwnerPubkey,omitempty"`
	CellarBrewerPubkey   string                   `protobuf:"bytes,4,opt,name=CellarBrewerPubkey,proto3" json:"CellarBrewerPubkey,omitempty"`
	CellarProducerPubkey string                   `protobuf:"bytes,5,opt,name=CellarProducerPubkey,proto3" json:"CellarProducerPubkey,omitempty"`
	ServiceTerms         []*CellarServiceTermItem `protobuf:"bytes,6,rep,name=ServiceTerms,proto3" json:"ServiceTerms,omitempty"`
	CellarGroupSeed      *GroupSeed               `protobuf:"bytes,7,opt,name=CellarGroupSeed,proto3" json:"CellarGroupSeed,omitempty"`
...
func (x *CellarSeed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellarSeed) ProtoMessage() {}

func (x *CellarSeed) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellarSeed.ProtoReflect.Descriptor instead.
func (*CellarSeed) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{30}
}

func (x *CellarSeed) GetCellarId() string {
	if x != nil {
		return x.CellarId
	}
	return ""
...
func (x *CellarSeed) GetCellarName() string {
	if x != nil {
		return x.CellarName
	}
	return ""
...
func (x *CellarSeed) GetCellarOwnerPubkey() string {
	if x != nil {
...
func (x *CellarSeed) GetCellarBrewerPubkey() string {
	if x != nil {
		return x.CellarBrewerPubkey
	}
	return ""
...
func (x *CellarSeed) GetCellarProducerPubkey() string {
	if x != nil {
		return x.CellarProducerPubkey
	}
	return ""
}

func (x *CellarSeed) GetServiceTerms() []*CellarServiceTermItem {
	if x != nil {
		return x.ServiceTerms
	}
	return nil
...
func (x *CellarSeed) GetCellarGroupSeed() *GroupSeed {
	if x != nil {
		return x.CellarGroupSeed
	}
	return nil
}

func (x *CellarSeed) GetHash() []byte {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *CellarSeed) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
type CellarRegisterGroupReqItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CellarId        string              `protobuf:"bytes,1,opt,name=CellarId,proto3" json:"CellarId,omitempty"`
	Seed            *GroupSeed          `protobuf:"bytes,2,opt,name=Seed,proto3" json:"Seed,omitempty"`
	CurrentBlockId  uint64              `protobuf:"varint,3,opt,name=CurrentBlockId,proto3" json:"CurrentBlockId,omitempty"`
	SeedOwnerPubkey string              `protobuf:"bytes,4,opt,name=SeedOwnerPubkey,proto3" json:"SeedOwnerPubkey,omitempty"`
	Proof           *CellarReqProofItem `protobuf:"bytes,5,opt,name=Proof,proto3" json:"Proof,omitempty"`
	Memo            string              `protobuf:"bytes,6,opt,name=Memo,proto3" json:"Memo,omitempty"`
	Hash            []byte              `protobuf:"bytes,7,opt,name=Hash,proto3" json:"Hash,omitempty"`
	Signature       []byte              `protobuf:"bytes,8,opt,name=Signature,proto3" json:"Signature,omitempty"`
}

func (x *CellarRegisterGroupReqItem) Reset() {
	*x = CellarRegisterGroupReqItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *CellarRegisterGroupReqItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellarRegisterGroupReqItem) ProtoMessage() {}

func (x *CellarRegisterGroupReqItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellarRegisterGroupReqItem.ProtoReflect.Descriptor instead.
func (*CellarRegisterGroupReqItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{31}
}

func (x *CellarRegisterGroupReqItem) GetCellarId() string {
	if x != nil {
		return x.CellarId
	}
	return ""
...
func (x *CellarRegisterGroupReqItem) GetSeed() *GroupSeed {
	if x != nil {
		return x.Seed
	}
	return nil
...
func (x *CellarRegisterGroupReqItem) GetCurrentBlockId() uint64 {
	if x != nil {
...
func (x *CellarRegisterGroupReqItem) GetSeedOwnerPubkey() string {
	if x != nil {
		return x.SeedOwnerPubkey
	}
	return ""
}

func (x *CellarRegisterGroupReqItem) GetProof() *CellarReqProofItem {
	if x != nil {
		return x.Proof
	}
	return nil
...
func (x *CellarRegisterGroupReqItem) GetMemo() string {
	if x != nil {
		return x.Memo
	}
	return ""
...
func (x *CellarRegisterGroupReqItem) GetHash() []byte {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *CellarRegisterGroupReqItem) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_chain_proto_rawDesc = []byte{
	...
	0x22, 0xfc, 0x02, 0x0a, 0x03, 0x54, 0x72, 0x78, 0x12, 0x14, 0x0a, 0x05, 0x54, 0x72, 0x78, 0x49,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x08, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65,
	0x4a, 0x04, 0x08, 0x09, 0x10, 0x65, 0x22, 0x92, 0x01, 0x0a, 0x10, 0x4e, 0x6f, 0x64, 0x65, 0x53,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_chain_proto_enumTypes = make([]protoimpl.EnumInfo, 20)
var file_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_chain_proto_goTypes = []interface{}{
	...
	(GroupServiceType)(0),              // 14: quorum.pb.GroupServiceType
	(CellarServiceType)(0),             // 15: quorum.pb.CellarServiceType
	(CellarGroupStatus)(0),             // 16: quorum.pb.CellarGroupStatus
	(HBMsgPayloadType)(0),              // 17: quorum.pb.HBMsgPayloadType
	(RBCMsgType)(0),                    // 18: quorum.pb.RBCMsgType
	(BBAMsgType)(0),                    // 19: quorum.pb.BBAMsgType
	(*Package)(nil),                    // 20: quorum.pb.Package
	(*PostItem)(nil),                   // 21: quorum.pb.PostItem
	(*ProducerItem)(nil),               // 22: quorum.pb.ProducerItem
	(*UpdGroupSyncerItem)(nil),         // 23: quorum.pb.UpdGroupSyncerItem
	(*Syncer)(nil),                     // 24: quorum.pb.Syncer
	(*ChainConfigItem)(nil),            // 25: quorum.pb.ChainConfigItem
	(*ChainSendTrxRuleListItem)(nil),   // 26: quorum.pb.ChainSendTrxRuleListItem
	(*SetTrxAuthModeItem)(nil),         // 27: quorum.pb.SetTrxAuthModeItem
	(*AppConfigItem)(nil),              // 28: quorum.pb.AppConfigItem
	(*Trx)(nil),                        // 29: quorum.pb.Trx
	(*Block)(nil),                      // 30: quorum.pb.Block
	(*BftMsg)(nil),                     // 31: quorum.pb.BftMsg
	(*SyncMsg)(nil),                    // 32: quorum.pb.SyncMsg
	(*ReqBlock)(nil),                   // 33: quorum.pb.ReqBlock
	(*ReqBlockResp)(nil),               // 34: quorum.pb.ReqBlockResp
	(*BlocksBundle)(nil),               // 35: quorum.pb.BlocksBundle
	(*BroadcastMsg)(nil),               // 36: quorum.pb.BroadcastMsg
	(*Consensus)(nil),                  // 37: quorum.pb.Consensus
	(*PoaConsensusInfo)(nil),           // 38: quorum.pb.PoaConsensusInfo
	(*ForkItem)(nil),                   // 39: quorum.pb.ForkItem
	(*GroupItem)(nil),                  // 40: quorum.pb.GroupItem
	(*GroupSeed)(nil),                  // 41: quorum.pb.GroupSeed
	(*BrewServiceTermItem)(nil),        // 42: quorum.pb.BrewServiceTermItem
	(*StorageServiceTermItem)(nil),     // 43: quorum.pb.StorageServiceTermItem
	(*CellarServiceTermItem)(nil),      // 44: quorum.pb.CellarServiceTermItem
	(*BrewServiceProofItem)(nil),       // 45: quorum.pb.BrewServiceProofItem
	(*StorageServiceProofItem)(nil),    // 46: quorum.pb.StorageServiceProofItem
	(*CellarReqProofItem)(nil),         // 47: quorum.pb.CellarReqProofItem
	(*CellarGroup)(nil),                // 48: quorum.pb.CellarGroup
	(*CellarItem)(nil),                 // 49: quorum.pb.CellarItem
	(*CellarSeed)(nil),                 // 50: quorum.pb.CellarSeed
	(*CellarRegisterGroupReqItem)(nil), // 51: quorum.pb.CellarRegisterGroupReqItem
	(*NodeSDKGroupItem)(nil),           // 52: quorum.pb.NodeSDKGroupItem
	(*HBTrxBundle)(nil),                // 53: quorum.pb.HBTrxBundle
	(*HBMsgv1)(nil),                    // 54: quorum.pb.HBMsgv1
	(*RBCMsg)(nil),                     // 55: quorum.pb.RBCMsg
	(*InitPropose)(nil),                // 56: quorum.pb.InitPropose
	(*Echo)(nil),                       // 57: quorum.pb.Echo
	(*Ready)(nil),                      // 58: quorum.pb.Ready
	(*BBAMsg)(nil),                     // 59: quorum.pb.BBAMsg
	(*Bval)(nil),                       // 60: quorum.pb.Bval
	(*Aux)(nil),                        // 61: quorum.pb.Aux
}
var file_chain_proto_depIdxs = []int32{
	0,  // 0: quorum.pb.Package.type:type_name -> quorum.pb.PackageType
	24, // 1: quorum.pb.UpdGroupSyncerItem.Syncer:type_name -> quorum.pb.Syncer
	...
	29, // 12: quorum.pb.Block.Trxs:type_name -> quorum.pb.Trx
	37, // 13: quorum.pb.Block.Consensus:type_name -> quorum.pb.Consensus
	...
	35, // 17: quorum.pb.ReqBlockResp.Blocks:type_name -> quorum.pb.BlocksBundle
	30, // 18: quorum.pb.BlocksBundle.Blocks:type_name -> quorum.pb.Block
	...
	39, // 21: quorum.pb.PoaConsensusInfo.ForkInfo:type_name -> quorum.pb.ForkItem
	30, // 22: quorum.pb.GroupItem.GenesisBlock:type_name -> quorum.pb.Block
	...
	30, // 25: quorum.pb.GroupSeed.GenesisBlock:type_name -> quorum.pb.Block
	12, // 26: quorum.pb.GroupSeed.SyncType:type_name -> quorum.pb.GroupSyncType
	15, // 27: quorum.pb.CellarServiceTermItem.Type:type_name -> quorum.pb.CellarServiceType
	15, // 28: quorum.pb.CellarReqProofItem.Type:type_name -> quorum.pb.CellarServiceType
	15, // 29: quorum.pb.CellarGroup.Type:type_name -> quorum.pb.CellarServiceType
	40, // 30: quorum.pb.CellarGroup.Group:type_name -> quorum.pb.GroupItem
	16, // 31: quorum.pb.CellarGroup.Status:type_name -> quorum.pb.CellarGroupStatus
	40, // 32: quorum.pb.CellarItem.CellarGroup:type_name -> quorum.pb.GroupItem
	44, // 33: quorum.pb.CellarItem.ServiceTerms:type_name -> quorum.pb.CellarServiceTermItem
	40, // 34: quorum.pb.CellarItem.StorageGroups:type_name -> quorum.pb.GroupItem
	40, // 35: quorum.pb.CellarItem.BrewGroups:type_name -> quorum.pb.GroupItem
	44, // 36: quorum.pb.CellarSeed.ServiceTerms:type_name -> quorum.pb.CellarServiceTermItem
	41, // 37: quorum.pb.CellarSeed.CellarGroupSeed:type_name -> quorum.pb.GroupSeed
	41, // 38: quorum.pb.CellarRegisterGroupReqItem.Seed:type_name -> quorum.pb.GroupSeed
	47, // 39: quorum.pb.CellarRegisterGroupReqItem.Proof:type_name -> quorum.pb.CellarReqProofItem
	40, // 40: quorum.pb.NodeSDKGroupItem.Group:type_name -> quorum.pb.GroupItem
	29, // 41: quorum.pb.HBTrxBundle.Trxs:type_name -> quorum.pb.Trx
	17, // 42: quorum.pb.HBMsgv1.PayloadType:type_name -> quorum.pb.HBMsgPayloadType
	18, // 43: quorum.pb.RBCMsg.Type:type_name -> quorum.pb.RBCMsgType
	19, // 44: quorum.pb.BBAMsg.Type:type_name -> quorum.pb.BBAMsgType
...
func file_chain_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chain_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BrewServiceTermItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chain_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StorageServiceTermItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chain_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CellarServiceTermItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chain_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BrewServiceProofItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chain_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*StorageServiceProofItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chain_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CellarReqProofItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chain_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CellarRegisterGroupReqItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
