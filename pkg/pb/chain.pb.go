...
const (
	HBMsgPayloadType_HB_BLOCK HBMsgPayloadType = 0
...
type HBBlockMsgType int32

const (
	HBBlockMsgType_RBC HBBlockMsgType = 0
	HBBlockMsgType_BBA HBBlockMsgType = 1
)

// Enum value maps for HBBlockMsgType.
var (
	HBBlockMsgType_name = map[int32]string{
		0: "RBC",
		1: "BBA",
	}
	HBBlockMsgType_value = map[string]int32{
		"RBC": 0,
		"BBA": 1,
	}
)

func (x HBBlockMsgType) Enum() *HBBlockMsgType {
	p := new(HBBlockMsgType)
	*p = x
	return p
}

func (x HBBlockMsgType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (HBBlockMsgType) Descriptor() protoreflect.EnumDescriptor {
	return file_chain_proto_enumTypes[15].Descriptor()
}

func (HBBlockMsgType) Type() protoreflect.EnumType {
	return &file_chain_proto_enumTypes[15]
}

func (x HBBlockMsgType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use HBBlockMsgType.Descriptor instead.
func (HBBlockMsgType) EnumDescriptor() ([]byte, []int) {
...
type HBMsgv1 struct {
	...
	PayloadType HBMsgPayloadType `protobuf:"varint,4,opt,name=PayloadType,proto3,enum=quorum.pb.HBMsgPayloadType" json:"PayloadType,omitempty"` //HB_BLOCK or HB_PSYNC
	Payload     []byte           `protobuf:"bytes,5,opt,name=Payload,proto3" json:"Payload,omitempty"`                                          //HBBlockMsg or HBPSyncMsg
}
...
func (x *HBMsgv1) GetPayloadType() HBMsgPayloadType {
	...
	return HBMsgPayloadType_HB_BLOCK
}
...
type HBBlockMsg struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	MsgType HBBlockMsgType `protobuf:"varint,1,opt,name=MsgType,proto3,enum=quorum.pb.HBBlockMsgType" json:"MsgType,omitempty"` //RBC or BBA
	Payload []byte         `protobuf:"bytes,2,opt,name=Payload,proto3" json:"Payload,omitempty"`                                //RBC msg or
}

func (x *HBBlockMsg) Reset() {
	*x = HBBlockMsg{}
	if protoimpl.UnsafeEnabled {
...
func (x *HBBlockMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HBBlockMsg) ProtoMessage() {}

func (x *HBBlockMsg) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HBBlockMsg.ProtoReflect.Descriptor instead.
func (*HBBlockMsg) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{21}
}

func (x *HBBlockMsg) GetMsgType() HBBlockMsgType {
	if x != nil {
		return x.MsgType
	}
	return HBBlockMsgType_RBC
}

func (x *HBBlockMsg) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
type Proof struct {
	...
	Leaves                 int64    `protobuf:"varint,4,opt,name=Leaves,proto3" json:"Leaves,omitempty"`
	OriginalDataSize       int64    `protobuf:"varint,5,opt,name=OriginalDataSize,proto3" json:"OriginalDataSize,omitempty"`
	OriginalProposerPubkey string   `protobuf:"bytes,6,opt,name=OriginalProposerPubkey,proto3" json:"OriginalProposerPubkey,omitempty"` //producer make this original inputval propose
	ProofProviderPubkey    string   `protobuf:"bytes,7,opt,name=ProofProviderPubkey,proto3" json:"ProofProviderPubkey,omitempty"`       //producer which broadcast this Proof
	ProofProviderSign      []byte   `protobuf:"bytes,8,opt,name=ProofProviderSign,proto3" json:"ProofProviderSign,omitempty"`           //signature of producer broadcast this Proof
}
...
func (x *Proof) GetOriginalProposerPubkey() string {
	if x != nil {
...
func (x *Proof) GetProofProviderPubkey() string {
	if x != nil {
...
func (x *Proof) GetProofProviderSign() []byte {
	if x != nil {
		return x.ProofProviderSign
	}
	return nil
}
...
func (x *HBPSyncMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HBPSyncMsg) ProtoMessage() {}

func (x *HBPSyncMsg) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HBPSyncMsg.ProtoReflect.Descriptor instead.
func (*HBPSyncMsg) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{29}
}

func (x *HBPSyncMsg) GetMsgType() PSyncMsgType {
	if x != nil {
		return x.MsgType
	}
...
func (x *HBPSyncMsg) GetPayload() []byte {
	if x != nil {
		return x.Payload
	}
	return nil
...
type PSyncResp struct {
	...
	GroupId       string             `protobuf:"bytes,1,opt,name=GroupId,proto3" json:"GroupId,omitempty"`
	SessionId     string             `protobuf:"bytes,2,opt,name=SessionId,proto3" json:"SessionId,omitempty"`
	MyCurEpoch    int64              `protobuf:"varint,3,opt,name=MyCurEpoch,proto3" json:"MyCurEpoch,omitempty"`
	MyCurProducer *PSyncProducerItem `protobuf:"bytes,4,opt,name=MyCurProducer,proto3" json:"MyCurProducer,omitempty"`
	ProducerProof *Trx               `protobuf:"bytes,5,opt,name=ProducerProof,proto3" json:"ProducerProof,omitempty"`
}
...
func (x *PSyncResp) GetMyCurProducer() *PSyncProducerItem {
	if x != nil {
		return x.MyCurProducer
	}
	return nil
}
...
var file_chain_proto_rawDesc = []byte{
	...
	0x54, 0x72, 0x78, 0x52, 0x04, 0x54, 0x72, 0x78, 0x73, 0x22, 0xac, 0x01, 0x0a, 0x07, 0x48, 0x42,
	0x4d, 0x73, 0x67, 0x76, 0x31, 0x12, 0x14, 0x0a, 0x05, 0x4d, 0x73, 0x67, 0x49, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x4d, 0x73, 0x67, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x53,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x45, 0x70, 0x6f,
	...
	0x07, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x5b, 0x0a, 0x0a, 0x48, 0x42, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x4d, 0x73, 0x67, 0x12, 0x33, 0x0a, 0x07, 0x4d, 0x73, 0x67, 0x54, 0x79, 0x70,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x71, 0x75, 0x6f, 0x72, 0x75, 0x6d,
	0x2e, 0x70, 0x62, 0x2e, 0x48, 0x42, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4d, 0x73, 0x67, 0x54, 0x79,
	0x70, 0x65, 0x52, 0x07, 0x4d, 0x73, 0x67, 0x54, 0x79, 0x70, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x50,
	...
	0x53, 0x69, 0x67, 0x6e, 0x22, 0xab, 0x02, 0x0a, 0x05, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x12, 0x1a,
	...
	0x65, 0x79, 0x12, 0x30, 0x0a, 0x13, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x50, 0x72, 0x6f, 0x76, 0x69,
	0x64, 0x65, 0x72, 0x50, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x13, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x50, 0x75,
	0x62, 0x6b, 0x65, 0x79, 0x12, 0x2c, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x50, 0x72, 0x6f,
	0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x11, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x53, 0x69,
	...
	0x6e, 0x0a, 0x04, 0x42, 0x76, 0x61, 0x6c, 0x12, 0x1e, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x70, 0x6f,
	0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x50, 0x72, 0x6f,
	0x70, 0x6f, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x53, 0x65, 0x6e, 0x64, 0x65,
	0x72, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x53, 0x65, 0x6e, 0x64, 0x65,
	0x72, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x18, 0x03, 0x20, 0x01,
	...
	0x6d, 0x0a, 0x03, 0x41, 0x75, 0x78, 0x12, 0x1e, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x59,
	0x0a, 0x0a, 0x48, 0x42, 0x50, 0x53, 0x79, 0x6e, 0x63, 0x4d, 0x73, 0x67, 0x12, 0x31, 0x0a, 0x07,
	...
	0x01, 0x28, 0x03, 0x52, 0x07, 0x4d, 0x79, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x12, 0x1e, 0x0a, 0x0a,
	0x53, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x0a, 0x53, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x22, 0xdd, 0x01, 0x0a,
	...
	,
	...
	0x09, 0x52, 0x06, 0x41, 0x70, 0x70, 0x4b, 0x65, 0x79, 0x2a, 0x39, 0x0a, 0x0b, 0x50, 0x61, 0x63,
	...
	0x48, 0x42, 0x42, 0x10, 0x02, 0x12, 0x0d, 0x0a, 0x09, 0x43, 0x4f, 0x4e, 0x53, 0x45, 0x4e, 0x53,
	0x55, 0x53, 0x10, 0x03, 0x2a, 0x2c, 0x0a, 0x0c, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65,
	...
	0x4f, 0x4e, 0x46, 0x49, 0x47, 0x10, 0x07, 0x2a, 0x50, 0x0a, 0x0c, 0x52, 0x65, 0x71, 0x42, 0x6c,
	...
	0x54, 0x5f, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x02, 0x2a, 0x2b, 0x0a, 0x10, 0x47, 0x72, 0x6f,
	...
	0x4f, 0x41, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x50, 0x4f, 0x53, 0x10, 0x01, 0x2a, 0x2c, 0x0a,
	0x06, 0x52, 0x6f, 0x6c, 0x65, 0x56, 0x30, 0x12, 0x12, 0x0a, 0x0e, 0x47, 0x52, 0x4f, 0x55, 0x50,
	0x5f, 0x50, 0x52, 0x4f, 0x44, 0x55, 0x43, 0x45, 0x52, 0x10, 0x00, 0x12, 0x0e, 0x0a, 0x0a, 0x47,
	0x52, 0x4f, 0x55, 0x50, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x10, 0x01, 0x2a, 0x4c, 0x0a, 0x0f, 0x43,
	...
	,
...
var file_chain_proto_goTypes = []interface{}{
	...
	(HBBlockMsgType)(0),              // 15: quorum.pb.HBBlockMsgType
	...
	(*HBTrxBundle)(nil),              // 38: quorum.pb.HBTrxBundle
	(*HBMsgv1)(nil),                  // 39: quorum.pb.HBMsgv1
	(*HBBlockMsg)(nil),               // 40: quorum.pb.HBBlockMsg
	(*RBCMsg)(nil),                   // 41: quorum.pb.RBCMsg
	(*InitPropose)(nil),              // 42: quorum.pb.InitPropose
	(*Proof)(nil),                    // 43: quorum.pb.Proof
	(*Ready)(nil),                    // 44: quorum.pb.Ready
	(*BBAMsg)(nil),                   // 45: quorum.pb.BBAMsg
	(*Bval)(nil),                     // 46: quorum.pb.Bval
	(*Aux)(nil),                      // 47: quorum.pb.Aux
	(*HBPSyncMsg)(nil),               // 48: quorum.pb.HBPSyncMsg
	(*PSyncReq)(nil),                 // 49: quorum.pb.PSyncReq
	(*PSyncResp)(nil),                // 50: quorum.pb.PSyncResp
...
var file_chain_proto_depIdxs = []int32{
	...
	15, // 28: quorum.pb.HBBlockMsg.MsgType:type_name -> quorum.pb.HBBlockMsgType
	16, // 29: quorum.pb.RBCMsg.Type:type_name -> quorum.pb.RBCMsgType
	17, // 30: quorum.pb.BBAMsg.Type:type_name -> quorum.pb.BBAMsgType
	18, // 31: quorum.pb.HBPSyncMsg.MsgType:type_name -> quorum.pb.PSyncMsgType
	51, // 32: quorum.pb.PSyncResp.MyCurProducer:type_name -> quorum.pb.PSyncProducerItem
	20, // 33: quorum.pb.PSyncResp.ProducerProof:type_name -> quorum.pb.Trx
	9,  // 34: quorum.pb.GroupItemV0.UserRole:type_name -> quorum.pb.RoleV0
	22, // 35: quorum.pb.GroupItemV0.GenesisBlock:type_name -> quorum.pb.Block
	7,  // 36: quorum.pb.GroupItemV0.EncryptType:type_name -> quorum.pb.GroupEncryptType
	8,  // 37: quorum.pb.GroupItemV0.ConsenseType:type_name -> quorum.pb.GroupConsenseType
