...
type CellaServiceType int32

const (
	CellaServiceType_BREW    CellaServiceType = 0
	CellaServiceType_STORAGE CellaServiceType = 1
)

// Enum value maps for CellaServiceType.
var (
	CellaServiceType_name = map[int32]string{
		0: "BREW",
		1: "STORAGE",
	}
	CellaServiceType_value = map[string]int32{
		"BREW":    0,
		"STORAGE": 1,
	}
)

func (x CellaServiceType) Enum() *CellaServiceType {
	p := new(CellaServiceType)
	*p = x
	return p
}

func (x CellaServiceType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CellaServiceType) Descriptor() protoreflect.EnumDescriptor {
	return file_chain_proto_enumTypes[15].Descriptor()
}

func (CellaServiceType) Type() protoreflect.EnumType {
	return &file_chain_proto_enumTypes[15]
}

func (x CellaServiceType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CellaServiceType.Descriptor instead.
func (CellaServiceType) EnumDescriptor() ([]byte, []int) {
...
type CellaServiceTermItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Type CellaServiceType `protobuf:"varint,1,opt,name=Type,proto3,enum=quorum.pb.CellaServiceType" json:"Type,omitempty"`
	Term []byte           `protobuf:"bytes,2,opt,name=Term,proto3" json:"Term,omitempty"`
}

func (x *CellaServiceTermItem) Reset() {
	*x = CellaServiceTermItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *CellaServiceTermItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellaServiceTermItem) ProtoMessage() {}

func (x *CellaServiceTermItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellaServiceTermItem.ProtoReflect.Descriptor instead.
func (*CellaServiceTermItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{24}
}

func (x *CellaServiceTermItem) GetType() CellaServiceType {
	if x != nil {
		return x.Type
	}
	return CellaServiceType_BREW
}

func (x *CellaServiceTermItem) GetTerm() []byte {
	if x != nil {
		return x.Term
	}
	return nil
...
func (x *CellaReqProofItem) Reset() {
	*x = CellaReqProofItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *CellaReqProofItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellaReqProofItem) ProtoMessage() {}

func (x *CellaReqProofItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellaReqProofItem.ProtoReflect.Descriptor instead.
func (*CellaReqProofItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{27}
}

func (x *CellaReqProofItem) GetType() CellaServiceType {
	if x != nil {
		return x.Type
	}
	return CellaServiceType_BREW
...
func (x *CellaReqProofItem) GetProof() []byte {
	if x != nil {
		return x.Proof
	}
	return nil
...
type CellaItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CellaId       string                  `protobuf:"bytes,1,opt,name=CellaId,proto3" json:"CellaId,omitempty"`
	CellaGroup    *GroupItem              `protobuf:"bytes,2,opt,name=CellaGroup,proto3" json:"CellaGroup,omitempty"`
	ServiceTerms  []*CellaServiceTermItem `protobuf:"bytes,3,rep,name=ServiceTerms,proto3" json:"ServiceTerms,omitempty"`
	StorageGroups []*GroupItem            `protobuf:"bytes,4,rep,name=StorageGroups,proto3" json:"StorageGroups,omitempty"`
	BrewGroups    []*GroupItem            `protobuf:"bytes,5,rep,name=BrewGroups,proto3" json:"BrewGroups,omitempty"`
}

func (x *CellaItem) Reset() {
	*x = CellaItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *CellaItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellaItem) ProtoMessage() {}

func (x *CellaItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellaItem.ProtoReflect.Descriptor instead.
func (*CellaItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{28}
}

func (x *CellaItem) GetCellaId() string {
	if x != nil {
		return x.CellaId
	}
	return ""
...
func (x *CellaItem) GetCellaGroup() *GroupItem {
	if x != nil {
		return x.CellaGroup
	}
	return nil
...
func (x *CellaItem) GetServiceTerms() []*CellaServiceTermItem {
	if x != nil {
...
func (x *CellaItem) GetStorageGroups() []*GroupItem {
	if x != nil {
...
func (x *CellaItem) GetBrewGroups() []*GroupItem {
	if x != nil {
		return x.BrewGroups
	}
	return nil
...
type CellaSeed struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CellaId             string                  `protobuf:"bytes,1,opt,name=CellaId,proto3" json:"CellaId,omitempty"`
	CellaName           string                  `protobuf:"bytes,2,opt,name=CellaName,proto3" json:"CellaName,omitempty"`
	CellaOwnerPubkey    string                  `protobuf:"bytes,3,opt,name=CellaOwnerPubkey,proto3" json:"CellaOwnerPubkey,omitempty"`
	CellaBrewerPubkey   string                  `protobuf:"bytes,4,opt,name=CellaBrewerPubkey,proto3" json:"CellaBrewerPubkey,omitempty"`
	CellaProducerPubkey string                  `protobuf:"bytes,5,opt,name=CellaProducerPubkey,proto3" json:"CellaProducerPubkey,omitempty"`
	ServiceTerms        []*CellaServiceTermItem `protobuf:"bytes,6,rep,name=ServiceTerms,proto3" json:"ServiceTerms,omitempty"`
	Group               *GroupSeed              `protobuf:"bytes,7,opt,name=Group,proto3" json:"Group,omitempty"`
...
func (x *CellaSeed) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellaSeed) ProtoMessage() {}

func (x *CellaSeed) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellaSeed.ProtoReflect.Descriptor instead.
func (*CellaSeed) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{29}
}

func (x *CellaSeed) GetCellaId() string {
	if x != nil {
		return x.CellaId
	}
	return ""
...
func (x *CellaSeed) GetCellaName() string {
	if x != nil {
		return x.CellaName
	}
	return ""
...
func (x *CellaSeed) GetCellaOwnerPubkey() string {
	if x != nil {
...
func (x *CellaSeed) GetCellaBrewerPubkey() string {
	if x != nil {
		return x.CellaBrewerPubkey
	}
	return ""
}

func (x *CellaSeed) GetCellaProducerPubkey() string {
	if x != nil {
		return x.CellaProducerPubkey
	}
	return ""
}

func (x *CellaSeed) GetServiceTerms() []*CellaServiceTermItem {
	if x != nil {
		return x.ServiceTerms
	}
	return nil
...
func (x *CellaSeed) GetGroup() *GroupSeed {
	if x != nil {
		return x.Group
	}
	return nil
...
func (x *CellaSeed) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
type CellaRegisterGroupReqItem struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Proof           *CellaReqProofItem `protobuf:"bytes,5,opt,name=Proof,proto3" json:"Proof,omitempty"`
	Memo            string             `protobuf:"bytes,6,opt,name=Memo,proto3" json:"Memo,omitempty"`
	Hash            []byte             `protobuf:"bytes,7,opt,name=Hash,proto3" json:"Hash,omitempty"`
	Signature       []byte             `protobuf:"bytes,8,opt,name=Signature,proto3" json:"Signature,omitempty"`
}

func (x *CellaRegisterGroupReqItem) Reset() {
	*x = CellaRegisterGroupReqItem{}
	if protoimpl.UnsafeEnabled {
...
func (x *CellaRegisterGroupReqItem) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CellaRegisterGroupReqItem) ProtoMessage() {}

func (x *CellaRegisterGroupReqItem) ProtoReflect() protoreflect.Message {
	mi := &file_chain_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CellaRegisterGroupReqItem.ProtoReflect.Descriptor instead.
func (*CellaRegisterGroupReqItem) Descriptor() ([]byte, []int) {
	return file_chain_proto_rawDescGZIP(), []int{30}
}

func (x *CellaRegisterGroupReqItem) GetCellaId() string {
	if x != nil {
		return x.CellaId
	}
	return ""
...
func (x *CellaRegisterGroupReqItem) GetSeed() *GroupSeed {
	if x != nil {
		return x.Seed
	}
	return nil
...
func (x *CellaRegisterGroupReqItem) GetCurrentBlockId() uint64 {
	if x != nil {
...
func (x *CellaRegisterGroupReqItem) GetSeedOwnerPubkey() string {
	if x != nil {
...
func (x *CellaRegisterGroupReqItem) GetProof() *CellaReqProofItem {
	if x != nil {
		return x.Proof
	}
	return nil
...
func (x *CellaRegisterGroupReqItem) GetMemo() string {
	if x != nil {
		return x.Memo
	}
	return ""
...
func (x *CellaRegisterGroupReqItem) GetHash() []byte {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *CellaRegisterGroupReqItem) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
var file_chain_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x41, 0x70, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x4a, 0x04, 0x08, 0x0e, 0x10,
	...
	0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x2f, 0x0a, 0x13, 0x42, 0x72, 0x65, 0x77, 0x53, 0x65, 0x72,
	...
	,
	...
	0x4d, 0x65, 0x6d, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x48, 0x61, 0x73, 0x68, 0x18, 0x07, 0x20, 0x01,
	...
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x4a, 0x04, 0x08, 0x09, 0x10, 0x65, 0x22, 0x92, 0x01, 0x0a,
	...
	0x75, 0x70, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x1c, 0x0a,
	...
	0x54, 0x72, 0x78, 0x73, 0x22, 0xa8, 0x01, 0x0a, 0x07, 0x48, 0x42, 0x4d, 0x73, 0x67, 0x76, 0x31,
	0x12, 0x14, 0x0a, 0x05, 0x4d, 0x73, 0x67, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x4d, 0x73, 0x67, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x49,
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x53, 0x63, 0x6f, 0x70, 0x65, 0x49, 0x64,
	...
	0x64, 0x54, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x71, 0x75,
	...
	,
	...
	,
	...
	0x6c, 0x6f, 0x61, 0x64, 0x22, 0x76, 0x0a, 0x04, 0x42, 0x76, 0x61, 0x6c, 0x12, 0x1e, 0x0a, 0x0a,
	0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0a, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x0c,
	...
	,
	...
	,
	...
	0x1c, 0x0a, 0x0d, 0x42, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x54, 0x79, 0x70, 0x65,
	0x12, 0x0b, 0x0a, 0x07, 0x47, 0x45, 0x4e, 0x45, 0x52, 0x41, 0x4c, 0x10, 0x00, 0x2a, 0x28, 0x0a,
	0x0d, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x53, 0x79, 0x6e, 0x63, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0a,
	...
	0x50, 0x4f, 0x41, 0x10, 0x00, 0x12, 0x07, 0x0a, 0x03, 0x50, 0x4f, 0x53, 0x10, 0x01, 0x2a, 0x28,
	0x0a, 0x10, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x09, 0x0a, 0x05, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x10, 0x00, 0x12, 0x09, 0x0a,
	0x05, 0x43, 0x45, 0x4c, 0x4c, 0x41, 0x10, 0x01, 0x2a, 0x2f, 0x0a, 0x10, 0x43, 0x65, 0x6c, 0x6c,
	0x61, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a, 0x04,
	0x42, 0x52, 0x45, 0x57, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x53, 0x54, 0x4f, 0x52, 0x41, 0x47,
	0x45, 0x10, 0x01, 0x22, 0x04, 0x08, 0x02, 0x10, 0x64, 0x2a, 0x24, 0x0a, 0x10, 0x48, 0x42, 0x4d,
...
var file_chain_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_chain_proto_goTypes = []interface{}{
	...
	(CellaServiceType)(0),             // 15: quorum.pb.CellaServiceType
	...
	(*UpdGroupSyncerItem)(nil),        // 22: quorum.pb.UpdGroupSyncerItem
	(*Syncer)(nil),                    // 23: quorum.pb.Syncer
	(*ChainConfigItem)(nil),           // 24: quorum.pb.ChainConfigItem
	(*ChainSendTrxRuleListItem)(nil),  // 25: quorum.pb.ChainSendTrxRuleListItem
	(*SetTrxAuthModeItem)(nil),        // 26: quorum.pb.SetTrxAuthModeItem
	(*AppConfigItem)(nil),             // 27: quorum.pb.AppConfigItem
	(*Trx)(nil),                       // 28: quorum.pb.Trx
	(*Block)(nil),                     // 29: quorum.pb.Block
	(*BftMsg)(nil),                    // 30: quorum.pb.BftMsg
	(*SyncMsg)(nil),                   // 31: quorum.pb.SyncMsg
	(*ReqBlock)(nil),                  // 32: quorum.pb.ReqBlock
	(*ReqBlockResp)(nil),              // 33: quorum.pb.ReqBlockResp
	(*BlocksBundle)(nil),              // 34: quorum.pb.BlocksBundle
	(*BroadcastMsg)(nil),              // 35: quorum.pb.BroadcastMsg
	(*Consensus)(nil),                 // 36: quorum.pb.Consensus
	(*PoaConsensusInfo)(nil),          // 37: quorum.pb.PoaConsensusInfo
	(*ForkItem)(nil),                  // 38: quorum.pb.ForkItem
	(*GroupItem)(nil),                 // 39: quorum.pb.GroupItem
	(*GroupSeed)(nil),                 // 40: quorum.pb.GroupSeed
	(*BrewServiceTermItem)(nil),       // 41: quorum.pb.BrewServiceTermItem
	(*StorageServiceTermItem)(nil),    // 42: quorum.pb.StorageServiceTermItem
	(*CellaServiceTermItem)(nil),      // 43: quorum.pb.CellaServiceTermItem
	(*BrewServiceProofItem)(nil),      // 44: quorum.pb.BrewServiceProofItem
	(*StorageServiceProofItem)(nil),   // 45: quorum.pb.StorageServiceProofItem
	(*CellaReqProofItem)(nil),         // 46: quorum.pb.CellaReqProofItem
	(*CellaItem)(nil),                 // 47: quorum.pb.CellaItem
	(*CellaSeed)(nil),                 // 48: quorum.pb.CellaSeed
	(*CellaRegisterGroupReqItem)(nil), // 49: quorum.pb.CellaRegisterGroupReqItem
...
var file_chain_proto_depIdxs = []int32{
	...
	23, // 1: quorum.pb.UpdGroupSyncerItem.Syncer:type_name -> quorum.pb.Syncer
	...
	28, // 12: quorum.pb.Block.Trxs:type_name -> quorum.pb.Trx
	36, // 13: quorum.pb.Block.Consensus:type_name -> quorum.pb.Consensus
	...
	34, // 17: quorum.pb.ReqBlockResp.Blocks:type_name -> quorum.pb.BlocksBundle
	29, // 18: quorum.pb.BlocksBundle.Blocks:type_name -> quorum.pb.Block
	...
	38, // 21: quorum.pb.PoaConsensusInfo.ForkInfo:type_name -> quorum.pb.ForkItem
	29, // 22: quorum.pb.GroupItem.GenesisBlock:type_name -> quorum.pb.Block
	...
	29, // 25: quorum.pb.GroupSeed.GenesisBlock:type_name -> quorum.pb.Block
	12, // 26: quorum.pb.GroupSeed.SyncType:type_name -> quorum.pb.GroupSyncType
	15, // 27: quorum.pb.CellaServiceTermItem.Type:type_name -> quorum.pb.CellaServiceType
	15, // 28: quorum.pb.CellaReqProofItem.Type:type_name -> quorum.pb.CellaServiceType
	39, // 29: quorum.pb.CellaItem.CellaGroup:type_name -> quorum.pb.GroupItem
	43, // 30: quorum.pb.CellaItem.ServiceTerms:type_name -> quorum.pb.CellaServiceTermItem
	39, // 31: quorum.pb.CellaItem.StorageGroups:type_name -> quorum.pb.GroupItem
	39, // 32: quorum.pb.CellaItem.BrewGroups:type_name -> quorum.pb.GroupItem
	43, // 33: quorum.pb.CellaSeed.ServiceTerms:type_name -> quorum.pb.CellaServiceTermItem
	40, // 34: quorum.pb.CellaSeed.Group:type_name -> quorum.pb.GroupSeed
	40, // 35: quorum.pb.CellaRegisterGroupReqItem.Seed:type_name -> quorum.pb.GroupSeed
	46, // 36: quorum.pb.CellaRegisterGroupReqItem.Proof:type_name -> quorum.pb.CellaReqProofItem
	39, // 37: quorum.pb.NodeSDKGroupItem.Group:type_name -> quorum.pb.GroupItem
	28, // 38: quorum.pb.HBTrxBundle.Trxs:type_name -> quorum.pb.Trx
	16, // 39: quorum.pb.HBMsgv1.PayloadType:type_name -> quorum.pb.HBMsgPayloadType
	17, // 40: quorum.pb.RBCMsg.Type:type_name -> quorum.pb.RBCMsgType
	18, // 41: quorum.pb.BBAMsg.Type:type_name -> quorum.pb.BBAMsgType
...
func file_chain_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chain_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CellaServiceTermItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chain_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CellaReqProofItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chain_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CellaRegisterGroupReqItem); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
