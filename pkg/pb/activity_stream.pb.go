...
type Object struct {
	...
	Published    *timestamp.Timestamp `protobuf:"bytes,16,opt,name=published,proto3" json:"published,omitempty"`
	Replies      *Object              `protobuf:"bytes,17,opt,name=replies,proto3" json:"replies,omitempty"`
	StartTime    *timestamp.Timestamp `protobuf:"bytes,18,opt,name=startTime,proto3" json:"startTime,omitempty"`
	...
	Updated      *timestamp.Timestamp `protobuf:"bytes,21,opt,name=updated,proto3" json:"updated,omitempty"`
...
func (x *Object) GetEndtime() *timestamp.Timestamp {
	if x != nil {
		return x.Endtime
	}
	return nil
...
func (x *Object) GetPublished() *timestamp.Timestamp {
	if x != nil {
		return x.Published
	}
	return nil
...
func (x *Object) GetStartTime() *timestamp.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *Activity) GetEndtime() *timestamp.Timestamp {
	if x != nil {
		return x.Endtime
	}
	return nil
...
func (x *Activity) GetPublished() *timestamp.Timestamp {
	if x != nil {
		return x.Published
	}
	return nil
...
func (x *Activity) GetStartTime() *timestamp.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *Activity) GetUpdated() *timestamp.Timestamp {
	if x != nil {
		return x.Updated
	}
	return nil
...
var file_activity_stream_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x70, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x42, 0x24, 0x5a, 0x22, 0x67, 0x69, 0x74, 0x68,
