...
func (h *Handler) JoinCellarBySeed() echo.HandlerFunc {
	return func(c echo.Context) error {
		cc := c.(*utils.CustomContext)

		params := new(handlers.JoinCellarBySeedParams)
		if err := cc.BindAndValidate(params); err != nil {
			return rumerrors.NewBadRequestError(err)
		}

		result, err := handlers.JoinCellarBySeed(params, options.GetNodeOptions(), h.Appdb)
		if err != nil {
			return err
		}
